...
public class Viewer extends JFrame {
   ...
   Menu Actions
   */
    private final Action saveToFileAction;
    private final Action loadFromFileAction;
    private final Action editParametersAction;
    private final Action skipSpatialPoolingAction;
    private final Action restartAction;
    private final Action htmResetAction;

    private final Action addInputAction;
    private final Action removePatternsAction;
    private final Action cleanInputSpaceAction;


    JCheckBoxMenuItem skipSpatialPoolMenuItem;

    private final JFileChooser fc = createFileChooser();
                ...
                if (modCfg != null) {
                    ...
                    HTMGraphicInterface.Config newCfg = new HTMGraphicInterface.Config(
                            ...
                            new Layer.Config(
                                    ...
                                    modRegionCfg.getInputRadius(), modRegionCfg.getLearningRadius(),
                                    modRegionCfg.isSkipSpatial(),
    ...
    private static class ExceptionHandler
        ...
        private static final int SHOW_LINES = 10;
